...
if __name__ == '__main__':
    ...
    # ===== Evaluation with language input (CLIP-guided) =====
    engine.eval(eval_dataloader_nature20_Clip, dataset_name='testdata_nature20_Clip',savedir=join(result_dir, 'testdata_nature20_Clip'))
    engine.eval(eval_dataloader_real20_Clip, dataset_name='testdata_real20_Clip',savedir=join(result_dir, 'testdata_real20_Clip'))
    engine.eval(eval_dataloader_wild55_Clip, dataset_name='testdata_wild55_Clip',savedir=join(result_dir, 'testdata_wild55_Clip'))
    engine.eval(eval_dataloader_postcard199_Clip, dataset_name='testdata_postcard199_Clip',savedir=join(result_dir, 'testdata_postcard199_Clip'))
    engine.eval(eval_dataloader_solid200_Clip, dataset_name='testdata_solid200_Clip',savedir=join(result_dir, 'testdata_solid200_Clip'))

    # ===== Evaluation without language input =====
    engine.eval(eval_dataloader_nature20, dataset_name='testdata_nature20',savedir=join(result_dir, 'testdata_nature20'))
    engine.eval(eval_dataloader_real20, dataset_name='testdata_real20',savedir=join(result_dir, 'testdata_real20'))
    engine.eval(eval_dataloader_wild55, dataset_name='testdata_wild55',savedir=join(result_dir, 'testdata_wild55'))
    engine.eval(eval_dataloader_postcard199, dataset_name='testdata_postcard199',savedir=join(result_dir, 'testdata_postcard199'))
    engine.eval(eval_dataloader_solid200, dataset_name='testdata_solid200',savedir=join(result_dir, 'testdata_solid200'))
